...
from blog.views import ProductPostListView, ProductPostDetailView, ProductPostUpdateView, ProductPostDeleteView, \
    ProductPostCreateView

app_name = BlogConfig.name

urlpatterns = [path("productpost_list/", ProductPostListView.as_view(), name="blog"),
