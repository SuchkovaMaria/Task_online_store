    ...
    def handle(self, *args, **kwargs):
        ...
        for product in products:
            if product["model"] == "catalog.category":
                category, created = Category.objects.get_or_create(name=product["fields"]["name"],
                ...
                product, created = Product.objects.get_or_create(name=product["fields"]["name"],
                                                                 description=product["fields"]["description"],
                                                                 price=product["fields"]["price"], category=category,
